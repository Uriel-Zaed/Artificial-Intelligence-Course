...
for p_1 in p1:
    ...
    for p_2 in p2:
        ...
        for _ in range(num_of_problems):
            ...
            print()
            print(f"BNB: assignments-{bnb.sol_UB}, cost-{bnb.UB}")
            print(f"BNB_FC: assignments-{bnb_fc.sol_UB}, cost-{bnb_fc.UB}")
            print(f"BNB_HUR: assignments-{bnb_hur.sol_UB}, cost-{bnb_hur.UB}")
